...
@can('deliveryList.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('deliveryList*') ? 'active' : '' }}" href="{!! route('deliveryList.index') !!}">@if($icons)<i class="nav-icon fa fa-truck"></i>@endif<p>{{trans('lang.deliveryList')}} </p></a>
    </li>
@endcan
